...
void Renderer2D::registerRenderable(WorldComponent* worldComp, RenderableComponent* rendComp) {
    std::list<std::pair<WorldComponent*, RenderableComponent*>>::iterator it;
    it = std::find_if(renderableComponents.begin(), renderableComponents.end(), [worldComp](const std::pair<WorldComponent*,RenderableComponent*>& pair){
